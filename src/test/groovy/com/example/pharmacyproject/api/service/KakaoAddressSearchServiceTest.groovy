...
class KakaoAddressSearchServiceTest extends AbstractIntegrationContainerBaseTest{
    ...
    def "주소값이 valid 한다면, requestAddressSearch 메소드는 정상적으로 document를 반환한디."(){
        ...
        then:
        result.documentList.size()>0 //documentList 사이즈 체크
        result.metaDto.totalCount>0 //metaDto 총개수 체크
        result.documentList.get(0).addressName!=null //documentList address name 체크
    }
