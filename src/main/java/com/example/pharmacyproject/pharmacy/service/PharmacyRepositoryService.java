...
public class PharmacyRepositoryService {
    ...
    public void foo(List<Pharmacy> pharmacyList) {
        log.info("foo CurrnetTransactionName:" + TransactionSynchronizationManager.getCurrentTransactionName());
    ...
    public void updateAddress(Long id, String address){
        ...
        if(Objects.isNull(entity)){
            log.error("[PharamcyRepositoryService updateAddress] not found id: {}",id);
            return;
        }
   ...
   @Transactional(readOnly = true) //dirty checking이 진행되지 않는다.
